...
/*
 * CreditCardApplyExceptionAdvice is a convenient base class for @RestControllerAdvice classes that wish to provide 
 * centralized exception handling across all @RequestMapping methods through @ExceptionHandler methods.
 * 
 */
@RestControllerAdvice
@Slf4j
public class CreditCardApplyExceptionAdvice extends ResponseEntityExceptionHandler {
	/**
	 ...
	 */
	@ExceptionHandler(CreditCardApplyException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<String> handleProfileException(CreditCardApplyException e, NativeWebRequest  webRequest) {
